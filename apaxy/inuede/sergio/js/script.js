		...
		var form = {
			...
			initialize: function() {
				...
				$form.validate({
					...
					messages: {
						name: {
							required:"<span class='form-message-error'>Por favor, introduce tu nombre.</span>"
						},
						email: {
							required:"<span class='form-message-error'>Por favor, introduce tu correo.</span>",
							email:"<span class='form-message-error'>Por favor, introduce tu correo.</span>"
						},
						message: {
							required: "<span class='form-message-error'>Por favor, deja algún mensaje.</span>"
						}
					},
