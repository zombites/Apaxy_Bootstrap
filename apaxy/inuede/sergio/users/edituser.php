<?php
	...
	$idusuario = substr( $url[ count($url)-1 ], 15 ); // Se extrae el id de la URL

	$conexion = Conectar();
	$fila = SelectSimple( $conexion, "*", "inuede_users", "id = " . $idusuario );

?>
								<h2 class="section-title-2">Edición usuario</h2>
